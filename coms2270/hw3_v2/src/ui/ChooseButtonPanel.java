...
public class ChooseButtonPanel extends JPanel
{
  ...
  private class ChooseButtonHandler implements ActionListener
  {
    ...
    public void actionPerformed(ActionEvent event)
    {
      ...
      String msg = null;
      ArrayList<LinesGame> games = null;
      LinesGame game = null;
        ...
        try
        {
          ...
          if (games.size() > 0)
          {
            ...
            if (game != null)
            {
              ...
              Dimension d = new Dimension(width * GamePanel.SIZE, height * GamePanel.SIZE);
              gamePanel.setPreferredSize(d);
//              d = new Dimension(width * GamePanel.SIZE, 3 * GamePanel.SIZE);
//              scorePanel.setPreferredSize(d);
              d = new Dimension(width * GamePanel.SIZE, GamePanel.SIZE);
